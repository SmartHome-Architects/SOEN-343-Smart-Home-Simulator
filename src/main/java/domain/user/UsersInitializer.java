    ...
    public static List<Users> initializeUsers(String usersFileName) {
        ...
        try (Scanner scanner = new Scanner(new File(usersFileName))) {
            while (scanner.hasNextLine()) {
                ...
                Permission permission = UserPermissionInitializer.initializePermission("database/DoorPermission.txt", "database/LightPermission.txt", "database/WindowPermission.txt", "database/SHHPermission.txt", userType);
