...
public class PermissionsPopupTest {
    ...
    public void testUpdateTableModel() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method updateTableModelMethod = PermissionsPopup.class.getDeclaredMethod("updateTableModel", String.class, DefaultTableModel.class);
        ...
        updateTableModelMethod.invoke(permissionsPopup, "Door", model);
